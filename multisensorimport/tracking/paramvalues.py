...
class ParamValues():
    ...
    def __init__(self, LK_window=35, pyr_level=3, quality_level=0.4, min_distance=0, max_corners=300, block_size=7, point_frac=0.7,
                 coarse_diam=5, coarse_sigma_color=100, coarse_sigma_space=100, fine_diam=20, fine_sigma_color=80, fine_sigma_space=80,
                 percent_fine=0.2, percent_coarse=0.8, displacement_weight=40, fine_threshold=0.45, update_rate=0.7, num_bottom=0, fix_top=False,
