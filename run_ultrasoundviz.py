...
READ_PATH = '/Users/akashvelu/Documents/Research_HART2/tracking_data/sub5_37/wp05t37/ultrasound_wp05t37/'
SEG_PATH = '/Users/akashvelu/Documents/Research_HART2/tracking_data/sub5_37/wp05t37/segs_wp05t37/'
OUT_PATH = '/Users/akashvelu/Documents/Research_HART2/tracking_data/sub5_37/wp05t37/data_wp05t37/'



def main():
    """Execute ultrasound image tracking visualization."""
    window_size = parameters.LK_window
    # set Lucas-Kanade optical flow parameters
    lk_params = dict(winSize=(window_size, window_size),
                     maxLevel= parameters.pyr_level,
    ...
    keyframe_path = SEG_PATH + '5389.pgm'
    ...
    tracking_contour_areas, ground_truth_contour_areas, ground_truth_thickness, ground_truth_thickness_ratio, tracking_thickness, tracking_thickness_ratio, iou_error = track.track_pts(SEG_PATH, READ_PATH, fine_filtered_points, fine_pts_inds, course_filtered_points, course_pts_inds, supporters_tracking, supporter_params, lk_params, True, feature_params, True, fine_filter_type=fineFilterNum, course_filter_type=courseFilterNum)
